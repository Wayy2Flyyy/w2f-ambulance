...
lib.callback.register('w2f-ambulance:server:getRecords', function(src, citizenid)
    -- Medical records are EMS-only. Without this any client could pull any
    -- citizen's clinical history via the callback.
