return {
    ...
    locations = { -- Various interaction points
        ...
        vehicle = {
            {
                spawn = vec4(294.578, -574.761, 43.179, 35.79),
                returnPoint = vec3(291.15, -577.45, 43.18),
            },
            {
                spawn = vec4(-234.28, 6329.16, 32.15, 222.5),
                returnPoint = vec3(-237.85, 6326.40, 32.15),
            },
        },
        helicopter = {
            {
                spawn = vec4(351.58, -587.45, 74.16, 160.5),
                returnPoint = vec3(348.20, -590.85, 74.16),
            },
            {
                spawn = vec4(-475.43, 5988.353, 31.716, 31.34),
                returnPoint = vec3(-478.90, 5985.10, 31.72),
            },
        },
        armory = {
            {
